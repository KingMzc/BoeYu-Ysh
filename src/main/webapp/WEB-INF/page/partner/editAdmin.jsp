...
<body class="childrenBody">
	<form class="layui-form" style="width: 80%;">
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<c:if test="${ad.flag=='1' }">
					<input type="radio" name="flag" value="1" title="通过" checked>
					<input type="radio" name="flag" value="2" title="待审核" >
				</c:if>
				<c:if test="${ad.flag=='2' }">
					<input type="radio" name="flag" value="1" title="通过" >
					<input type="radio" name="flag" value="3" title="未通过">
				</c:if>
				<c:if test="${ad.flag=='3' }">
					<input type="radio" name="flag" value="1" title="通过" >
					<input type="radio" name="flag" value="3" title="未通过" checked>
				</c:if>
			</div>
		</div>
		<div class="layui-form-item">
	...
	<script type="text/javascript" src="${ctx }/page/partner/editAdmin.js"></script>
</body>
</html>